...
<div id="global">
	...
	<p>L’atelier atouts et réussites a pour objectif de</p>	
		<ul>
	...
	<p>Face à un problème, un dysfonctionnement ou un objectif, vous avez mis en place une <b>solution</b> qui a amené un <b>résultat</b>.</p>
	<h2>C’EST UNE REALISATION</h2>
	<p>Une <b>réalisation</b>, c’est intéressant parce que c’est la base de votre expérience  professionnelle, <b>la preuve</b>  de votre  <b>savoir-faire</b>.</p>
	<p>C’est  donc par l’approche <em>Réalisation</em>&nbsp;&nbsp;&nbsp;que nous vous proposons d’avancer.</p>
	<p>Une <b>réalisation</b> peut se décrire en répondant à 4 questions :	</p>
		<ul>
